...
public class GoodsMDiv {
	...
	private String festgoods_mdiv_nm;
	...
	public String getFestgoods_mdiv_nm() {
		return festgoods_mdiv_nm;
	}
	public void setFestgoods_mdiv_nm(String festgoods_mdiv_nm) {
		this.festgoods_mdiv_nm = festgoods_mdiv_nm;
	}
	@Override
	public String toString() {
		return "GoodsMDiv [festgoods_mdiv_cd=" + festgoods_mdiv_cd + ", areacity_admin_cd=" + areacity_admin_cd
				+ ", fest_cd=" + fest_cd + ", area_city_cd=" + area_city_cd + ", area_cd=" + area_cd + ", fest_nm="
				+ fest_nm + ", festgoods_ldiv_cd=" + festgoods_ldiv_cd + ", festgoods_mdiv_nm=" + festgoods_mdiv_nm
				+ "]";
	}
